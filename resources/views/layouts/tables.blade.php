       ...
       <div class="row mb-2 mt-1">
        ...
        <div class="table-responsive">
            ...
            <tr>
                ...
                <td>
                       <a href="/tampilkandata/{{ $item->id  }}"><i class="fa-solid fa-pen-to-square"></i></a> 
                        @csrf
                       <a href="#"><i class="fa-solid fa-trash delete" data-id="{{ $item->id }}" data-nama="{{ $item->NAMA_CUSTOMER }}"  style="color: red"></i></a>
                </form>
              </td>
              </td>
          </tr> 
    ...
    var table = $('.yajra-datatable').DataTable({
        ...
        serverSide: true,
         columns: [
            ...
            {data: 'TRX', name: 'TRX'},
            {data: 'TYPE_MITRA', name: 'TYPE_MITRA'},
            {data: 'AMMOUNT_FIX', name: 'AMMOUNT_FIX'},
            {data: 'PRODUK_FIX', name: 'PRODUK_FIX'},
            {data: 'BUCKET_NAME', name: 'BUCKET_NAME'},
            {data: 'Type_Produk', name: 'Type_Produk'},
            {data: 'TYPE_BISNIS', name: 'TYPE_BISNIS'},
            {data: 'REV_INPPN', name: 'REV_INPPN'},
            {data: 'PAJAK', name: 'PAJAK'},
            {data: 'REV_EXPPN', name: 'REV_EXPPN'},
            {data: 'HPP', name: 'HPP'},
            {data: 'TOTAL_HPP_INPPN', name: 'TOTAL_HPP_INPPN'},
            {data: 'TOTAL_HPP_EXPPN', name: 'TOTAL_HPP_EXPPN'},
            {data: 'Margin_INPPN', name: 'Margin_INPPN'},
            {data: 'Margin_EXPPN', name: 'Margin_EXPPN'},
            {data: 'Hari', name: 'Hari'},
            {data: 'Bulan', name: 'Bulan'},
            {data: 'KET_PROD', name: 'KET_PROD'},
            {
                data: 'action',
                name: 'action',
                orderable: true,
